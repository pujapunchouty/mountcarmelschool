...
function check_wpztabs_widget() {
     if( is_active_widget(false, false, 'wpzoom-tabbed-widget', true ) ) {
       // enqueue the script
...
class tabbed_widget extends WP_Widget {
	...
	function tabbed_widget() {
		...
		$control_ops = array( 'width' => 230, 'height' => 300, 'id_base' => 'wpzoom-tabbed-widget' );
		$this->WP_Widget( 'wpzoom-tabbed-widget', __('WPZOOM: Tabs'), $widget_ops, $control_ops );
	}

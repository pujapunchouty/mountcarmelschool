	...
	<div id='footer-background'>
		...
		<div class='footer_txt'>
			<div class='container'>
				...
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://smthemes.com/ecotour/' target='_blank'>Free themes</a>, thanks to: <a href='http://wpdis.co/free/yummyblog/' target='_blank'>Free WordPress food themes</a>, <a href='http://npkid.com/homebirth-midwife-what-you-should-know/' target='_blank'>Home Birth</a> and <a href='http://fthe.me/metro-facebook-timeline-wordpress-template/' target='_blank'>Free WordPress template</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
		</div>
